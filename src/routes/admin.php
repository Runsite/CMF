...
Route::group(['prefix' => (config('app.env') === 'testing' ? config('app.fallback_locale') : LaravelLocalization::setLocale()).'/admin', 'namespace' => 'Runsite\CMF\Http\Controllers', 'middleware'=>['remember.files', 'check-admin-ip', 'localeSessionRedirect', 'localizationRedirect', 'localeViewPath', 'web']], function() {
