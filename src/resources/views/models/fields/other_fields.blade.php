			...
			<ul class="nav nav-pills nav-stacked">
				@foreach($fields as $fieldItem)
					<li class="{{ $fieldItem->id == $field->id ? 'active' : null }}">
						<a class="ripple" href="{{ route('admin.models.fields.edit', ['model_id'=>$model->id, 'field_id'=>$fieldItem->id]) }}" onclick="$(this).parent().parent().find('li').removeClass('active'); $(this).parent().addClass('active')">
